...
- **Navigace:** sticky header, animovaný hamburger menu na mobilu (`js/main.js`), plynulé rozbalení přes `max-height` transition
...
⚠️ **Při přidávání nových stránek nezapomenout linkovat `js/main.js` před `</body>`.**
